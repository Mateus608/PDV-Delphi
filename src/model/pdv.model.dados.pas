...
begin
  cdsItenssubtotal.AsCurrency := (cdsItensvalorunitario.AsCurrency * cdsItensquantidade.AsCurrency); //calcula o valor unitario * quantidade = subtotal
end;
